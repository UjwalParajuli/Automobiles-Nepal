...
public class BodyTypeAdapter extends RecyclerView.Adapter<BodyTypeAdapter.ViewHolder> {
    ArrayList<CarsModel> carsModelArrayList;
    Context context;

    public BodyTypeAdapter(ArrayList<CarsModel> carsModelArrayList, Context context) {
    ...
    @NonNull
    @Override
    public BodyTypeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        Context context = viewGroup.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view =inflater.inflate(R.layout.item_body_type, viewGroup, false);
        BodyTypeAdapter.ViewHolder viewHolder =new BodyTypeAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull BodyTypeAdapter.ViewHolder holder, int position) {
        ...
        text_view_body_type_name.setText(carsModel.getCar_body_type());
