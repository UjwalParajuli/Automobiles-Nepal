...
public class AllBodyTypeFragments extends Fragment {
    private RecyclerView recycler_view_fragment_all_body_types;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_body_type, container, false);

        recycler_view_fragment_all_body_types = view.findViewById(R.id.recycler_view_fragment_all_body_types);
            ...
            public void onResponse(String response) {
                if (response.trim().equals("not_found")) {
                    ...
                    try {
                        ...
                        recycler_view_fragment_all_body_types.setLayoutManager(gridLayoutManager);

                        // Grid item spacing
                        int spanCount = 2; // 3 columns
                        int spacing = 50; // 50px
                        boolean includeEdge = false;
                        recycler_view_fragment_all_body_types.addItemDecoration(new GridSpacingItemDecoration(spanCount, spacing, includeEdge));
                        recycler_view_fragment_all_body_types.setAdapter(bodyTypeAdapter);
                        bodyTypeAdapter.notifyDataSetChanged();

                        ItemClickSupport.addTo(recycler_view_fragment_all_body_types).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                            @Override
