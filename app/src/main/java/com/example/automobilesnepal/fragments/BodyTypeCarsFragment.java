...
public class BodyTypeCarsFragment extends Fragment {
    private Bundle bundle;
    private CarsModel carsModel;
    private TextView text_view_fragment_body_type_cars;
    private RecyclerView recycler_view_fragment_body_type_cars;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_body_type_cars, container, false);

        bundle = getArguments();
        carsModel = (CarsModel) bundle.getSerializable("body_type");
        text_view_fragment_body_type_cars = view.findViewById(R.id.text_view_fragment_body_type_cars);
        recycler_view_fragment_body_type_cars = view.findViewById(R.id.recycler_view_fragment_body_type_cars);

        carsModelArrayList = new ArrayList<>();
        carsAdapter = new CarsAdapter(carsModelArrayList, getContext());

        text_view_fragment_body_type_cars.setText(carsModel.getCar_body_type() + " " + "Cars");
    ...
    private void getBodyTypeCars(){
        String url = "http://192.168.1.65:81/android/get_body_type_cars.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.trim().equals("not_found")) {
                    ...
                    try {
                        ...
                        recycler_view_fragment_body_type_cars.setLayoutManager(gridLayoutManager);

                        // Grid item spacing
                        int spanCount = 2; // 3 columns
                        int spacing = 50; // 50px
                        boolean includeEdge = false;
                        recycler_view_fragment_body_type_cars.addItemDecoration(new GridSpacingItemDecoration(spanCount, spacing, includeEdge));
                        recycler_view_fragment_body_type_cars.setAdapter(carsAdapter);
                        carsAdapter.notifyDataSetChanged();

                        ItemClickSupport.addTo(recycler_view_fragment_body_type_cars).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("body_type", carsModel.getCar_body_type());
                return params;
            }
