...
public class MyBookingsFragment extends Fragment {
    private User user;
    private LinearLayout completed_car_bookings, completed_bike_bookings;
    private RecyclerView recycler_view_fragment_my_car_bookings, recycler_view_fragment_my_bike_bookings;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        completed_car_bookings = view.findViewById(R.id.completed_car_bookings);
        completed_bike_bookings = view.findViewById(R.id.completed_bike_bookings);
        recycler_view_fragment_my_car_bookings = view.findViewById(R.id.recycler_view_fragment_my_car_bookings);
        recycler_view_fragment_my_bike_bookings = view.findViewById(R.id.recycler_view_fragment_my_bike_bookings);
    ...
    private void getCarBookings(){
        String url = "http://192.168.1.65:81/android/get_my_car_bookings.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.trim().equals("not_found")) {
                    completed_car_bookings.setVisibility(View.GONE);
                    ...
                    try {
                        ...
                        recycler_view_fragment_my_car_bookings.setLayoutManager(linearLayoutManager);
                        recycler_view_fragment_my_car_bookings.setAdapter(usedCarsAdapter);
                        recycler_view_fragment_my_car_bookings.addItemDecoration(new SpacesItemDecoration(20));
                        usedCarsAdapter.notifyDataSetChanged();

                        ItemClickSupport.addTo(recycler_view_fragment_my_car_bookings).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                            @Override
    ...
    private void getBikeBookings(){
        String url = "http://192.168.1.65:81/android/get_my_bike_bookings.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.trim().equals("not_found")) {
                    completed_bike_bookings.setVisibility(View.GONE);
                    ...
                    try {
                        ...
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
                        recycler_view_fragment_my_bike_bookings.setLayoutManager(linearLayoutManager);
                        recycler_view_fragment_my_bike_bookings.setAdapter(usedBikesAdapter);
                        recycler_view_fragment_my_bike_bookings.addItemDecoration(new SpacesItemDecoration(20));
                        usedBikesAdapter.notifyDataSetChanged();

                        ItemClickSupport.addTo(recycler_view_fragment_my_bike_bookings).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                            @Override
                            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
