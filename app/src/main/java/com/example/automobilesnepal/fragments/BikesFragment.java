...
public class BikesFragment extends Fragment {
    ...
    private void getBrands(){
        CarBrandsModel carBrandsModel = new CarBrandsModel("bajaj", "Bajaj",1);
        CarBrandsModel carBrandsModel2 = new CarBrandsModel("benelli", "Benelli", 2);
        CarBrandsModel carBrandsModel3 = new CarBrandsModel("crossfire", "Crossfire", 3);
        CarBrandsModel carBrandsModel4 = new CarBrandsModel("honda", "Honda", 4);
